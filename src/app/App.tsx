        ...
        <Router>
          <motion.div {...slideInTransition}>
            <Routes>
              ...
              <Route path="/AfriQExpress" element={<AfriQExpress />} />
              <Route path="/AfriQTrans" element={<AfriQTrans />} />
              <Route path="/aboutus" element={<NewAbout />} />
              <Route path="/afriqpay" element={<AfriqPay />} />
              <Route path="/afriqpayexpress" element={<AfriqPayExpress />} />
            </Routes>
          </motion.div>
        </Router>
      </AnimatePresence>
